...
int main(){
   ...
   init_data.index_memory_manager_thread_num = init_data.data_disk_manager_thread_num;
   ...
   init_data.disk_read_size = disk_read_size;
   ...
   // init_data.dpdk_core_id_list = std::vector<u_int32_t>({4,6,8,10,12,14,16,18});
   // init_data.packet_core_id_list = std::vector<u_int32_t>({4,6,8,10,12,14,16,18});
   // init_data.indexing_core_id_list = std::vector<u_int32_t>({20,22});
