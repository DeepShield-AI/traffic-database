...
class SkipList{
    ...
    void* newNode(std::string key, u_int64_t value, u_int32_t level, char* memory){
        ...
        if(this->keyLen == 1){
            ...
            SkipListNode<u_int8_t,u_int64_t>* p = (SkipListNode<u_int8_t,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
            ...
            SkipListNode<u_int16_t,u_int64_t>* p = (SkipListNode<u_int16_t,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
            ...
            SkipListNode<u_int32_t,u_int64_t>* p = (SkipListNode<u_int32_t,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
            ...
            SkipListNode<u_int64_t,u_int64_t>* p = (SkipListNode<u_int64_t,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
        }else if(this->keyLen == 12){
            QuarTurpleIPv4* real_key= (QuarTurpleIPv4*)&(key[0]);
            // SkipListNode<QuarTurpleIPv4,u_int64_t>* p = new SkipListNode<QuarTurpleIPv4,u_int64_t>(*real_key,value,level);
            SkipListNode<QuarTurpleIPv4,u_int64_t>* p = (SkipListNode<QuarTurpleIPv4,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
            ...
            SkipListNode<IPv6Address,u_int64_t>* p = (SkipListNode<IPv6Address,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
            ...
            SkipListNode<QuarTurpleIPv6,u_int64_t>* p = (SkipListNode<QuarTurpleIPv6,u_int64_t>*)memory;
            p->init(*real_key,value,level);
            pointer = (void*)p;
        }else{
    ...
    void putNext(void* node, u_int32_t level, void* next){
        if(this->keyLen == 1){
            ...
            SkipListNode<QuarTurpleIPv4,u_int64_t>* p = (SkipListNode<QuarTurpleIPv4,u_int64_t>*)node;
            p->next[level] = (SkipListNode<QuarTurpleIPv4,u_int64_t>*)next;
        }else if(this->keyLen == 16){
            SkipListNode<IPv6Address,u_int64_t>* p = (SkipListNode<IPv6Address,u_int64_t>*)node;
...
public:
    SkipList(u_int32_t maxLvl, u_int32_t keyLen, u_int32_t valueLen) : maxLevel(maxLvl), level(0), nodeNum(0), keyLen(keyLen), valueLen(valueLen) {
        ...
        u_int32_t size = this->keyLen + this->valueLen + sizeof(SpinLock) + sizeof(u_int32_t) + sizeof(void*) * this->maxLevel;
        void* mem = malloc(size);
        // char* memory = new char[size];
        this->head = this->newNode(std::string(this->keyLen,0),0,this->maxLevel,(char*)mem);
